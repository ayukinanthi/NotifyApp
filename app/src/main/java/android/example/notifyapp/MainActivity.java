package android.example.notifyapp;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void sendNotification(){
        ...
        PendingIntent morePendingIntent=PendingIntent.getActivity
                (this, NOTIFICATION_ID, moreIntent, PendingIntent.FLAG_ONE_SHOT);
        ...
        NotificationCompat.Builder notifyBuilder=new NotificationCompat.Builder(this, CHANNEL_ID)
                .setContentTitle("Notif Title").setSmallIcon(R.mipmap.ic_launcher_round).setContentText("Notif Content")
        ...
        Notification notification1=notifyBuilder.build();
